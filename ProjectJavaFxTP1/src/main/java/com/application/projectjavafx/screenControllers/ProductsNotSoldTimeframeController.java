...
public class ProductsNotSoldTimeframeController implements ControlledScreen {
...
//
//    Report report = new Report(thirtyDaysAgoDate, todayDate, "productsNotSoldTimeframe");
//
//    ArrayList<Product> productsArrayList = report.productsNotSoldTimeframe(thirtyDaysAgoDate, todayDate);
//
