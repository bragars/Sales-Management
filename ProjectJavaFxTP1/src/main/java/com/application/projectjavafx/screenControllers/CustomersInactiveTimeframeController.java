...
public class CustomersInactiveTimeframeController implements ControlledScreen {
...
//
//    Report report = new Report(sixMonthsAgoDate, todayDate, "CustomersInactiveTimeframe");
//
//    ArrayList<Customer> customersArrayList = report.customersInactiveTimeframe(sixMonthsAgoDate, todayDate);
//
