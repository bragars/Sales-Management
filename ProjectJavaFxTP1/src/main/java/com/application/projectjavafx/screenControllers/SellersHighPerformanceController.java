...
public class SellersHighPerformanceController implements ControlledScreen {
...
//
//    Report report = new Report(threeMonthsAgoDate, todayDate, "SellersHighPerformance");
//
//    ArrayList<Employee> employeesArrayList = report.sellersHighPerformance(1.2, threeMonthsAgoDate, todayDate);
